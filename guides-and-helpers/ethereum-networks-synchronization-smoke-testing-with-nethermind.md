...
On the Tools tab, we may also run the [_Portainer_](https://www.portainer.io/) __docker instance. With _Portainer_ we can manage docker containers on each machine, stop, restart, or even view the logs live and all of these in a single place.
