...
| **标签** | 说明 | 架构 |
| :--- | :--- | :--- |
| `最新` | The latest **Nethermind Alpine** based image | x86\_64 |
...
For example if you wish to use version `1.7.4` of **Nethermind Alpine** image, the image name would be `1.7.4` , for **Nethermind ARM64 Alpine** `1.7.4-arm64` _\*\*_and so on and so forth.
