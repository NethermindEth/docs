...
- [Deploy Nethermind Teku Ethereum Nodes via AWS Blockchain Node Runners](#deploy-nethermind-teku-ethereum-nodes-via-aws-blockchain-node-runners)
...
- **`--JsonRpc.EstimateErrorMargin <value>`** `NETHERMIND_JSONRPCCONFIG_ESTIMATEERRORMARGIN`
  ...
  The error margin used in eth_estimateGas expressed in basis points. Defaults to `150`.
...
## Deploy Nethermind Teku Ethereum Nodes via AWS Blockchain Node Runners
