...
<Tabs>
    <TabItem label="Mainnet" default>
        ...
        from
        [above](https://docs.nethermind.io/nethermind/first-steps-with-nethermind/running-nethermind-post-merge#checkpoint-sync).
        Example:
        ```bash
        --trusted-node-url=https://beaconstate.ethstaker.cc
        ```
    </TabItem>
    <TabItem label="Goerli">
        ```bash
        nimbus-eth2/build/nimbus_beacon_node \
        --network=goerli \
        --web3-url=http://127.0.0.1:8551 \
...
check [here](../../ethereum-client/networks.md).
...
<Tabs>
    <TabItem label="Windows">```bash ./Nethermind.Launcher ```</TabItem>
    <TabItem label="Ubuntu">```bash nethermind ```</TabItem>
    <TabItem label="macOS">``` nethermind-launcher ```</TabItem>
</Tabs>
...
<Tabs>
    <TabItem label="Windows">
        ```bash ./Nethermind.Runner --config goerli --JsonRpc.JwtSecretFile=PATH ```
    </TabItem>
    <TabItem label="Ubuntu">
        ``` nethermind --config goerli --JsonRpc.JwtSecretFile=PATH ```
    </TabItem>
    <TabItem label="macOS">
        ```bash nethermind --config goerli --JsonRpc.JwtSecretFile=PATH ```
    </TabItem>
</Tabs>
