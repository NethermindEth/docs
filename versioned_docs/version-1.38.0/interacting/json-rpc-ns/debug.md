...
Generates an execution witness for a single call at a specific block, capturing all state accessed during the call.

<Tabs>
<TabItem value="params" label="Parameters">

1. `callRequest`: _object_
...
curl localhost:8545 \
  ...
  --data '{
      ...
      "params": [callRequest, blockParameter]
    }'
```
